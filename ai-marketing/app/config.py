...
# ---- 受众人群（#7 超个性化，同选题按人群出多版本）----
AUDIENCE_SEGMENTS = {
    "小户型": "强调省空间/折叠/尺寸精算，痛点是空间小",
    "新中式": "强调质感/木纹/搭配氛围，痛点是怕买得廉价",
    "预算有限": "强调性价比/耐用/避坑，痛点是怕花冤枉钱",
    "品质改善": "强调全实木/工艺/环保等级，痛点是怕甲醛和劣质",
    "新婚置家": "强调成套搭配/一步到位/送装，痛点是怕零散难搭",
}
