...
$payload = [ordered]@{
    ...
    plan_id = 7
    expected_attempt_id = 'ab51f002ac5570c9bb407d00'
    expected_terminal_evidence_request_id = 'single-discount-terminal-30223e509426a655'
    expected_scope_sha256 = '80e603ca57aa2974ab892f9ad1738e3dbd3b00d3b026ad80dd7aed642085371a'
}
$raw = $payload | ConvertTo-Json -Compress
$remote = 'sudo -n /var/packages/ContainerManager/target/usr/bin/docker exec -i panse-system-api-1 python -m app.cli.campaign_verify_plan7_discount_identity_readback'
...
try {
    ...
    if ($exitCode -ne 0) {
        ...
        throw "计划7提交后只读收口失败，退出码 $exitCode$diagnostic"
    }
} finally {
