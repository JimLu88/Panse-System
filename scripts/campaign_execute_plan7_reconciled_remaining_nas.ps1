...
$payload = [ordered]@{
    ...
    expected_item_scope_sha256 = '1f66d114e711b0fb3448a8a1503120bb5edd35a2d6416105f66545392f15bc86'
...
try {
    ...
    if ($exitCode -ne 0) {
        ...
        throw "计划7核对后剩余5个商品一次性报名失败，退出码 $exitCode$diagnostic$responseJson"
    }
} finally {
