...
if __name__=='__main__':
    ...
    mode.add_argument('--recover-local-generation',action='store_true')
    args=parser.parse_args()
    operation=recover_local_generation if args.recover_local_generation else recover_scope_projection if args.recover_scope_projection else recover_include_window
