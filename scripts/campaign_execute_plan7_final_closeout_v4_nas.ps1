...
$payload = [ordered]@{
    ...
    source_bundle_id = 'f6dd4cb3b7ffea16178efd6b'
    ...
    expected_source_manifest_sha256 = '40337eb5781ce17a55c2787535e7137c6bde39fbdfb78a15676f6530322de013'
    ...
    official_export_record_id = '330012453'
    expected_official_export_sha256 = 'a9ec3974dd1fc251f2b3dd7163fa4fcd8f8b08fd710424d85b1a7c0b723e0afd'
    expected_extra_sku_id = '6280268983409'
}
$raw = $payload | ConvertTo-Json -Compress
$remote = 'sudo -n /var/packages/ContainerManager/target/usr/bin/docker exec -i panse-system-api-1 python -m app.cli.campaign_execute_plan7_final_closeout_v4'
...
try {
    ...
    if ($exitCode -ne 0) {
        ...
        throw "计划7最终收口 V4 CLI 失败，退出码 $exitCode$responseJson"
    }
} finally {
