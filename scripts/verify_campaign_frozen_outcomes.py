...
def verify(contract, receipt):
    ...
    fixed = {
        ...
        "custom_replacement_policy": {
            "scope": "current_failed_custom_skus_only_with_current_user_authorization",
            "ordinary_default_rotation": False,
            "verified_classification_required": True,
            "direct_feasible_price_fix_first": True,
            "reuse_verified_inactive_reserve_first": True,
            "unknown_is_missing": False,
            "identity": ["item", "erp_code", "source_sku", "replacement_sku"],
            "floor_follows_original_business_sku_across_replacements": True,
            "replacement_resets_platform_history_guaranteed": False,
            "record_on_actual_change_or_submission": True,
            "daily_price_scan": False,
            "batch_fill_identical_attributes": True,
            "one_time_authorization_is_recurring": False,
        },
