...
class CampaignPlan8FinalRecoveryV8In(BaseModel):
    ...
    mode: str = Field(pattern=(
        ...
        r"resume_claimed_preupload_v14|resume_claimed_preupload_v15|"
        r"resume_claimed_preupload_v16|resume_claimed_preupload_v17|"
        ...
        r"resume_claimed_preupload_v26|resume_claimed_preupload_v27|"
        r"resume_claimed_preupload_v28)$"))
    confirmation: str
    target_scope_sha256: str = Field(pattern=r"^[0-9a-f]{64}$")
    manual_export_filename: str = Field(default="", max_length=160)
    manual_export_size: int = Field(default=0, ge=0, le=262144)
    manual_export_sha256: str = Field(default="", max_length=64)
    manual_export_base64: str = Field(default="", max_length=400000)
