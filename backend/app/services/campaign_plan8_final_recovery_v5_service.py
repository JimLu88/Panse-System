...
RECOVERY_VERSION = 5
OPERATION = "plan8_final_recovery_v5"
EXECUTION_SOURCE = "campaign_super88_plan8_final_recovery_v5"
...
EXECUTE_CONFIRMATION = "EXECUTE_ONCE_PLAN8_V5_6_ITEMS_78_SKUS_18_CUSTOM"
READBACK_CONFIRMATION = "READBACK_ONLY_PLAN8_V5_NO_PLATFORM_WRITE"
...
def recover_plan8_final_v3(
    ...
    inspection = web_agent_service.recover_plan8_final_v5(
    ...
    attempt = CampaignExecutionAttempt(
        ...
        request_id=f"plan8-final-v5-{secrets.token_hex(8)}",
    ...
    try:
        committed = web_agent_service.recover_plan8_final_v5(
    ...
    try:
        readback = web_agent_service.recover_plan8_final_v5(
