...
# 用户人工费表 [小, 中, 大]
_LABOR = {
    "床": [600, 700, 780], "床头柜": [220, 260, 320], "梳妆台": [600, 700, 800],
    "斗柜": [600, 800, 1000], "镜子": [400, 500, 600], "电视柜": [420, 560, 700],
...
_PRICES = {
    ...
    "红橡木-2.2cm": 240, "榉木-2.2cm": 280, "实木多层板1.8cm": 220, "海洋板1.8cm": 100, "樱桃木-2.8cm": 520,
...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    # 盈亏平衡工厂价 (净不亏 = 售价 − 全部非工厂成本): 报价侧无真实订单, 用这两率估平台扣点+税
    # (订单/对账侧用定价表 accounting_cost 里的真实扣点/税, 不用这两个默认)。
    "platform_fee_rate": 0.05,      # 平台扣点率 (售价占比, 淘宝/天猫扣点; 后台按你实际改)
