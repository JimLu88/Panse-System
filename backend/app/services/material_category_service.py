...
AC_CATEGORY_RULES: list[tuple[str, list[str]]] = [
    ("岩板", ["岩板"]),
    ("洞石饰面板", ["洞石", "饰面板", "纹理饰面"]),
    ("电力轨道", ["电力轨道", "xpower", "power轨"]),
    ("铝合金槽", ["铝合金"]),
    ("五金", [
        "灯带", "变压器", "灯开关", "灯堵头", "充电灯", "无线充电", "夜灯", "小夜灯", "射灯",
        "反弹抽屉", "抽屉轨道", "托底抽屉", "翻盖支撑", "支撑杆", "气撑",
        "床板拉绳", "拉绳", "结构胶", "橡胶垫", "胶垫",
        "金属腿", "金属条", "金属脚", "铰链", "把手", "拉手",
        "螺丝", "双面胶",
    ]),
    ("玻璃", ["玻璃", "镜"]),
    ("杂项", [
...
DEFAULT_CONSUMABLES = [
    {"name": "双面胶", "unit": "个", "price": Decimal("0.1"), "category": "五金"},
    {"name": "螺丝", "unit": "个", "price": Decimal("0.1"), "category": "五金"},
]
