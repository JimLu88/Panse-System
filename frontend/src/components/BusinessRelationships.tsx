...
export default function BusinessRelationships() {
  ...
  return <Space direction="vertical" size="middle" style={{ width: '100%' }} className="business-relationships">
    <div className="br-header"><div><Typography.Title level={3} style={{ margin: 0 }}>关系流程</Typography.Title><Typography.Text type="secondary">先看业务，再检查改动会影响哪里</Typography.Text></div><Button onClick={() => query.refetch()}>刷新关系核查</Button></div>
