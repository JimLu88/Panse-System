...
export default function ShopPriceBoardPage() {
  ...
  const columns: ColumnsType<ShopPriceRow> = [
    ...
    marginCol,
    { title: <span>超级立减<br />报名价</span>, dataIndex: 'signup_price_mid', width: 108, align: 'right',
      render: (v: number | null) => <span style={{ color: '#1a73e8', fontWeight: 700 }}>{yuan(v)}</span> },
    { title: <span>普通大促<br />报名价</span>, dataIndex: 'signup_price_big', width: 108, align: 'right',
      render: (v: number | null) => <span style={{ color: '#1a73e8', fontWeight: 700 }}>{yuan(v)}</span> },
    { title: <span>618/双11<br />报名价</span>, dataIndex: 'signup_price_618', width: 116, align: 'right',
